        ...
        <div className="grid md:grid-cols-5 gap-12 items-center">
          ...
          <div className="md:col-span-2 order-1 md:order-2 flex justify-center">
            <div className="relative">
              {/* Background circle */}
              <div className="w-80 h-80 md:w-92 md:h-92 rounded-full bg-primary/20 relative overflow-hidden flex items-center justify-center">
                ...
                <div className="w-80 h-80 md:w-92 md:h-92 relative">
                  {/* Loading placeholder */}
                  {!imageLoaded && (
                  ...
                  <img
                    src="https://i.postimg.cc/8CFgD7QQ/applicant-photo-bg-removed.png"
