            ...
            >
              <CardContent className="p-5 flex flex-col h-full">
                ...
                <div className="aspect-[4/3] bg-gradient-to-br from-secondary/20 to-secondary/10 rounded-lg overflow-hidden relative mb-4">
                  ...
                  <Badge
                    variant="secondary"
                    className="absolute top-2 left-2 bg-primary/10 text-primary border-primary/20 text-xs px-2 py-0.5"
                  >
                    {project.category}
                  </Badge>
                  <div className="absolute top-2 right-2 w-8 h-8 bg-gradient-to-br from-primary/20 to-accent/20 rounded-lg flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
