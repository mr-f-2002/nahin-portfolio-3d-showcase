          ...
          {displayedProjects.map((project, index) => (
            <Card
              ...
              className={`border border-primary/10 bg-gradient-to-br from-card to-card/80 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 ${
                index <= initialProjectCount ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}
            >
                ...
                <div className="mt-auto">
                  {project.link ? (
                    <Button
                      variant="outline"
                      asChild
                      className="w-full h-12 text-base font-semibold border-primary/20 text-primary hover:bg-primary hover:text-primary-foreground transition-all duration-300"
                    >
