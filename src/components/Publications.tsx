            ...
            >
              ...
              <div className="flex items-start gap-3 md:gap-6">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {/* Metrics & DOI */}
                  {pub.status === "published" && (
                    <div className="flex flex-col sm:flex-row sm:flex-wrap sm:items-center gap-2 sm:gap-3 mt-3 sm:mt-4">
                      {pub.metrics && (
                        <span className="inline-flex items-center px-3 py-1 bg-primary/10 text-primary text-xs font-semibold rounded-full w-fit">
                          {pub.metrics}
                        </span>
                      )}
                      {pub.doiUrl && (
                        <a
                          ...
                          className="inline-flex items-center gap-1.5 text-xs sm:text-sm text-primary hover:underline break-all"
                        >
